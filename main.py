...
# Optimisation graphique pour Android
...
# --- 1. GÉNÉRATION AUDIO ULTRA-LÉGÈRE (Anti-Crash) ---
def generate_audio_files():
    # On génère un son très court et léger pour éviter le lag
    if not os.path.exists('score.wav'):
        sample_rate = 22050 # Réduit pour la performance
        duration = 0.1
